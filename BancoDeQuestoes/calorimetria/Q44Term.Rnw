...
\begin{question}
   ...
   Qual é o volume ocupado por $\Sexpr{mol1}$ mols de gás perfeito submetido à pressão de $\Sexpr{press1}$ N/m², a uma temperatura igual a $\Sexpr{temp1}$ ºC? Dado: R= 0.082 atm.l / mol.K e 1atm=10000N/m². Qual era a pressão inicial?
