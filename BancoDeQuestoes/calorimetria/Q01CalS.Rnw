...
\begin{answerlist}
  ...
  \item A quantidade de calor absorvida (em calorias) por uma massa de 1 g de zinco eu eleva sua temperatura em $\Sexpr{dta}$°C
  
  \item A quantidade de calor absorvida (em calorias) por uma massa de $\Sexpr{mb}$ g de zinco que eleva sua temperatura em 1°C
