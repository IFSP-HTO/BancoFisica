...
%% SOLUTION
\begin{solution}
A fonte fornece calor à taxa de \(\Sexpr{c_recebido}\,\mathrm{cal/min}\) durante \(20\,\mathrm{min}\). Assim, o calor recebido é
\[
  Q=\Sexpr{c_recebido}\cdot20
   =\Sexpr{c_recebido*20}\,\mathrm{cal}.
\]
...
\[
  \Delta T=\frac{Q}{C}
          =\frac{\Sexpr{c_recebido*20}}{\Sexpr{capac}}
          =\Sexpr{result}\,^{\circ}\mathrm{C}.
\]
