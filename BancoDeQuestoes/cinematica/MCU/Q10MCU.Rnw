...
Se em um anemômetro a distância entre as conchas e o centro de rotação é r = \Sexpr{R_cm} cm, em um dia cuja velocidade do vento é v = \Sexpr{v} m/s, qual seria a frequência de rotação em RPM?
