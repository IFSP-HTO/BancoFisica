...
\end{figure}
  ...
  \item O trabalho realizado pelo sistema no processo AC. \textit{Caso necessário, arredonde sua resposta para uma casa decimal}

  \item O trabalho realizado pelo sistema no processo ABC. \textit{Caso necessário, arredonde sua resposta para uma casa decimal}

  \item A variação da energia interna do sistema no processo AC. \textit{Caso necessário, arredonde sua resposta para uma casa decimal}
  
  \item A variação da energia interna do sistema no processo ABC. \textit{Caso necessário, arredonde sua resposta para uma casa decimal}
