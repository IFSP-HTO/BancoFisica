...
\end{figure}
  ...
  \item O trabalho realizado pelo gás durante a transformação AB. \textit{Caso necessário, arredonde sua resposta para uma casa decimal}

  \item O trabalho realizado pelo gás durante a transformação BC.  \textit{Caso necessário, arredonde sua resposta para uma casa decimal}
  \item O trabalho realizado pelo gás durante a transformação CA. \textit{Caso necessário, arredonde sua resposta para uma casa decimal}
  
  \item O trabalho total realizado pelo gás no ciclo ABCA. \textit{Caso necessário, arredonde sua resposta para uma casa decimal}
  
  \item A variação da energia interna no ciclo ABCA. \textit{Caso necessário, arredonde sua resposta para uma casa decimal}
