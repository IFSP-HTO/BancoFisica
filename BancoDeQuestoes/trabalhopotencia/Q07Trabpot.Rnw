...
Uma pessoa de $\Sexpr{m} kg$ sobe $\Sexpr{deg}$ degraus dessa escada em $\Sexpr{t} segundos$, num local onde a aceleração da gravidade é de $10 m/s^2$. Desprezando eventuais perdas por atrito, determine:
